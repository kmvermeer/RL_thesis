...
{
  emxInit_real_T(&pStruct->incstr, 2);
  emxInit_real_T(&pStruct->edgelabel, 2);
  emxInit_real_T(&pStruct->Mpar, 2);
  emxInit_real_T(&pStruct->Hpar, 2);
  emxInit_real_T(&pStruct->Spar, 2);
  emxInit_real_T(&pStruct->Ppar, 2);
  emxInit_real_T(&pStruct->Pmpar, 2);
  emxInit_real_T(&pStruct->bestTrajectory, 2);
}
...
/*
 * File trailer for simulateDNA_emxutil.c
 *
 * [EOF]
 */
